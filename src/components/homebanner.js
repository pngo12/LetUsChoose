...
const HomeBanner = () => {
    return ( 
        ...
        <div className="columns is-gapless">
            <div className="column is-4 has-background-primary is-narrow">
                <div className="container is-fluid">
                    ...
                    <p classNameName="content is-pulled-left">
            ...
            <div className="column is-4 has-background-link is-narrow">
                <div className="container is-fluid">
                    <br />
                    ...
                    <p className="content is-pulled-left">If your group of friends are the indecisive type then we're the solution type.
                 LUC isn't just for your boo, it's for the homies too. Let us know what your options are, and we'll randomly choose one.</p>
                </div>

            </div>
            <div className="column is-4 has-background-warning is-narrow">
                ...
                <div className="container is-fluid">
                    ...
                    <h1 className="title">Options got your head exploding?</h1>
                    <p className="content is-pulled-left">Don't worry, we know that feeling. 5000 channels yet there's "nothing" to watch. Too
